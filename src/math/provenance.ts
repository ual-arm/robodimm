/** Canonical JSON and synchronous SHA-256 for browser-side report provenance. */
...
export const canonicalSha256 = (value: unknown): string => sha256Hex(stableStringify(value));
